...
export function StylizedImage({ shape = 0, className, ...props }) {
  ...
  return (
    <div
      className={clsx(
        className,
        'relative flex aspect-square w-full ', // Consider the aspect ratio for your specific SVG
      )}
    >
      <svg viewBox="0 0 512 512" fill="none" className="h-full"> {/* Adjust viewBox if needed */}
        <g clipPath={`url(#${id}-clip)`} className="group">
          <g className="origin-center scale-100 transition duration-500 motion-safe:group-hover:scale-105">
            <foreignObject width={width} height={height}>
              <Image
                alt=""
                className="w-24 bg-neutral-100 object-cover"
